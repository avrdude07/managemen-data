...
// Komponen untuk tombol edit
export const EditButton = ({ onClick, title = "Edit Data" }) => (
  <button
...
// Komponen untuk tombol hapus
export const DeleteButton = ({ onClick, title = "Hapus Data" }) => (
  <button
    className="btn btn-sm d-flex align-items-center justify-content-center"
    style={{
      width: "30px",
...
// Komponen gabungan untuk kedua tombol
const ActionButtons = ({ onEdit, onDelete, editTitle, deleteTitle }) => (
  <div className="d-flex gap-1">
    <EditButton onClick={onEdit} title={editTitle} />
